...
const faqData = [
  {
    id: 1,
    question: "كيف أبدأ مع الكورسات؟",
    answer: "البدء سهل! ما عليك سوى إنشاء حساب، تصفح كتالوج الكورسات لدينا، وسجل في الكورسات التي تهمك. يمكنك البدء في التعلم فوراً بعد التسجيل. جميع الكورسات ذاتية السرعة، لذا يمكنك التعلم بالسرعة التي تناسبك."
  },
  {
    id: 2,
    question: "ما هي طرق الدفع التي تقبلونها؟",
    answer: "نحن نقبل Instapay transfer وVodafone Cash كطرق دفع رئيسية. كما نقبل جميع بطاقات الائتمان الرئيسية وبطاقات الخصم. جميع المدفوعات تتم معالجتها بأمان من خلال شركائنا الموثوقين في الدفع. كما نقدم خطط تقسيط لبعض الكورسات."
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer: "نحن نقدم ضمان استرداد الأموال لمدة 30 يوماً لجميع الكورسات. إذا لم تكن راضياً تماماً عن تجربة التعلم الخاصة بك، ما عليك سوى الاتصال بفريق الدعم لدينا خلال 30 يوماً من الشراء للحصول على استرداد كامل."
  },
  {
    id: 6,
