        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`grid gap-4 mb-8 ${isAdmin ? 'grid-cols-1 md:grid-cols-4' : 'grid-cols-1 md:grid-cols-3'}`}>
            <div className="bg-[#3A5A7A]-50 dark:bg-[#3A5A7A]-900/20 p-4 rounded-lg">
              ...
              <div className="text-sm text-[#3A5A7A]-600 dark:text-[#4D6D8E]">إجمالي الأسئلة والأجوبة</div>
            </div>
            ...
            {isAdmin && (
              <div className="bg-[#3A5A7A]-50 dark:bg-[#3A5A7A]-900/20 p-4 rounded-lg">
                ...
                <div className="text-sm text-[#3A5A7A]-600 dark:text-[#4D6D8E]">في الانتظار</div>
              </div>
            )}
            <div className="bg-[#3A5A7A]-50 dark:bg-[#3A5A7A]-900/20 p-4 rounded-lg">
              <div className="text-2xl font-bold text-[#3A5A7A]-600 dark:text-[#4D6D8E]">
              ...
              <div className="text-sm text-[#3A5A7A]-600 dark:text-[#4D6D8E]">مميز</div>
            </div>
          </div>
